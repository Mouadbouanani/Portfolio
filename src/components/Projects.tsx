...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const uniqueTopics = Array.from(new Set(allTopics)).filter(t => t !== 'portfolio');
      setTechnologies(['All', ...uniqueTopics]);

    } catch (err) {
      console.error('❌ Error loading projects:', err);
      setError('Failed to load projects. The file may not exist yet. Please trigger the GitHub Action manually.');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-lg p-8 max-w-2xl mx-auto">
                <p className="text-gray-300 mb-4">No portfolio projects found.</p>
                <p className="text-gray-400 text-sm mb-6">
                  Add the <code className="bg-slate-700 px-2 py-1 rounded">portfolio</code> topic to your GitHub repositories.
                </p>
      ...
      <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div
              ...
              viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">My Projects</h2>
            <p className="text-center text-gray-400 mb-2">
              Showing {filteredProjects.length} of {projects.length} portfolio {projects.length === 1 ? 'project' : 'projects'}
            </p>
            {lastUpdated && (
                  ...
                  <div className="p-6">
                    ...
                    {project.topics && project.topics.length > 0 && (
                        <div className="flex flex-wrap gap-2 mb-4">
                          ...
                          {project.topics.filter(t => t !== 'portfolio').length > 4 && (
